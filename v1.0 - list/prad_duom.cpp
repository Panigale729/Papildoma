...
void darbas_su_generuotais(list<studentas>& grupe, bool skirstymas) {
    long long int stud_sk = 1000; //maziausias failas
    int n = 0;

    list<studentas> silpnuciai;
    list<studentas> gudruciai;

    cout << "Jeigu norite generuoti failus - iveskite „1“\n";
    cout << "Jeigu norite dirbti su is anksto sugeenruotais failais - iveskite „0“\n";
...
void darbas_su_paruostais(list<studentas>& grupe) {
...
void darbas_su_ivedimu(list<studentas>& grupe) {
    string isvest_fail = "kursiokai.txt";
...
list<studentas> studentu_pildymas() {
