...
void darbas_su_generuotais(deque<studentas>& grupe, bool skirstymas) {
    long long int stud_sk = 1000; //maziausias failas
    int n = 0;

    deque<studentas> silpnuciai;
    deque<studentas> gudruciai;

    cout << "Jeigu norite generuoti failus - iveskite „1“\n";
    cout << "Jeigu norite dirbti su is anksto sugeneruotais failais (testavimui) - iveskite „0“\n";
...
void darbas_su_paruostais(deque<studentas>& grupe) {
...
void darbas_su_ivedimu(deque<studentas>& grupe) {
    string isvest_fail = "kursiokai.txt";
...
deque<studentas> studentu_pildymas() {
