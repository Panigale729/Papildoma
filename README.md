...
## Programos aprašymas (pakeitimai nuo v0.1 versijos):
   ...
   - Rezultatai taip pat išvedami į failą, naudojant stringstream visų duomenų suvedimui į viena stringą, o tada išvedama į failą. Taip pat, studentai yra rūšiuojami pagal pavardę ir išvedimo lentelė dinamiškai prisitaiko pagal ilgiausią studentų vardą ir pavardę.
